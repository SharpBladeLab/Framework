...
class AlipayNotify {
	...
	function verifyNotify(){
		if(empty($_POST)) {//判断POST来的数组是否为空
			...
			$log_text=$log_text."\n-------------\n";
			$log_text=$log_text."mysign:".$mysign."\n";
			$log_text=$log_text."sign:".$_POST["sign"]."\n---------\n";
			$log_text = $log_text."config:".createLinkString($this->aliapy_config)."\n";
			$log_text = $log_text."notify_id:".$_POST["notify_id"]."\n";
			logResult($log_text);
			//验证
