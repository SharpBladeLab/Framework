 ...
 *
 * $Id: TagLibCx.class.php 515 2013-07-30 08:59:14Z wgw $
 *
 ...
 */
 ...
 class TagLibCx extends TagLib
 {
    ...
    public function _space($attr,$content) {
        ...
        return "<?php echo getUserSpace($uid,'$class','$target','$content') ?>";
    }    
    ...
    public function _url($attr) {
        ...
        $module   = !empty($tag['module'])?$tag['module']:CONTROLLER_NAME;
