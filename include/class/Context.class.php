 ...
 * 运行时上下文(应用程序的运行环境本身)
 * 
 *   1.Context 主要封装了请求参数和请求状态，以及 URL 解析等功能。
 *   2.Context 使用了单子设计模式，因此只能使用 Context::instance() 来获得 Context对象的唯一实例。
 *   3.Context 实现了 ArrayAccess 接口，可以将 Context 对象当作数组一样使用。
 */
 class Context extends Framework implements ArrayAccess
 {
     ...
     * 返回 Context 对象的唯一实例
     *
     * @return Context QContext 对象的唯一实例
     */
