 ...
 * @version     $Id: Route.class.php 682 2013-01-07 09:47:54Z wgw $
 ...
 */
 class Route 
 {
	...
	private function parsePath() {
		...
		} elseif( empty($param[0]) || strtolower($param[0]) == 'index.php' || strtolower($param[0]) == 'admin.php' ) {
			/* Default Mode */
			$this->param['APP'] = $this->config['DEFAULT_APP'];
	...
	private function _stopDDOS(){
		...
		$yesno && $str.=$checkip.$checkuri.$time."1\r\n";
